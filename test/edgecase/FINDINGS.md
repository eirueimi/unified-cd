...
- Violations: 7 (W0-1 split-brain [major], W0-1 crash-loop-no-retry [minor], W0-1 NOTIFY-docs-overclaim [minor], W0-2 TZ-divergent leaders [major], W0-2 catch-up-window silent-and-permanent skip [major], W0-2 backward-clock-step bounded stall [minor], W0-2 DST-gap day-skip [minor]) — 3 from W0-1 + 4 from W0-2 (3 major: W0-1 split-brain, W0-2 TZ-divergent, W0-2 catch-up-window; 4 minor: W0-1 crash-loop-no-retry, W0-1 NOTIFY-docs-overclaim, W0-2 backward-clock-step, W0-2 DST-gap). Observations: 1 (W0-2 combined DST-fold + backlog-drain-rate entry).
